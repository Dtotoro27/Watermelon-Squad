		...
		if (position.x < SCREEN_WIDTH && position.x > 0) {
			...
			if (timer > 190) {
				if (timer == 200) {
					...
					App->particles->AddParticle(App->particles->big_enemy_shoot, position.x + 28, position.y + 42, v_x + 1, v_y + 1, COLLIDER_ENEMY_SHOT);

					App->particles->AddParticle(App->particles->big_enemy_shoot_born, position.x + 28, position.y + 49, v_x + 1, v_y + 1, COLLIDER_ENEMY_SHOT);
					App->particles->AddParticle(App->particles->big_enemy_shoot_born, position.x + 28, position.y + 42, v_x - 1, v_y + 1, COLLIDER_ENEMY_SHOT);
