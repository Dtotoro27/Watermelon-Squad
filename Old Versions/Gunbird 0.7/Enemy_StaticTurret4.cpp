...
Enemy_StaticTurret4::Enemy_StaticTurret4(int x, int y) : Enemy(x, y)
{
	...
	movement.PushBack({ 0.0f,-0.825f }, 170, &base);
...
void Enemy_StaticTurret4::Shoot() {
	if (App->sea->pause == false) {
