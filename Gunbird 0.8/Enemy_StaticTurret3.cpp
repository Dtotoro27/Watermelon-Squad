...
Enemy_StaticTurret3::Enemy_StaticTurret3(int x, int y) : Enemy(x, y)
{
	...
	movement.PushBack({ 0.0f,-0.825f }, 650, &base);
...
void Enemy_StaticTurret3::Shoot() {
	if (App->sea->pause == false) {
