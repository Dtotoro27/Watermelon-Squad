...
Enemy_ShipVerticalCanon2::Enemy_ShipVerticalCanon2(int x, int y) : Enemy(x, y)
{


	enemypos.PushBack({ 6,878,18,31 });

	shootopen_left.PushBack({ 79,918,18,31 });
	shootopen_left.PushBack({ 79,955,18,31 });
	shootopen_left.PushBack({ 79,992,18,31 });
	shootopen_left.loop = false;
	shootopen_left.speed = 0.1f;

	shootclose_left.PushBack({ 79,992,18,31 });
	shootclose_left.PushBack({ 79,955,18,31 });
	shootclose_left.PushBack({ 79,918,18,31 });
	shootclose_left.loop = false;
	shootclose_left.speed = 0.1;

	shootopen_right.PushBack({ 6,918,18,31 });
	shootopen_right.PushBack({ 6,955,18,31 });
	shootopen_right.PushBack({ 6,992,18,31 });
	shootopen_right.loop = false;
	shootopen_right.speed = 0.1f;

	shootclose_right.PushBack({ 6,992,18,31 });
	shootclose_right.PushBack({ 6,955,18,31 });
	shootclose_right.PushBack({ 6,918,18,31 });
...
void Enemy_ShipVerticalCanon2::Move()
{
...
void Enemy_ShipVerticalCanon2::Shoot() {
	if (App->sea->pause == false) {
