...
Enemy_BigShipMove2::Enemy_BigShipMove2(int x, int y) : Enemy(x, y)
{
	...
	movement.PushBack({ 0.0f,-0.875f }, 1050, &base);
	movement.PushBack({ 0.0f,-0.782f }, 300, &base);
	movement.PushBack({ -1.0f,-0.482f }, 700, &base);
